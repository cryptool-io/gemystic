    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted">
          ...
          <code className="rounded-sm bg-surface-2 px-1.5 py-0.5 text-brand-dark">data/taxonomy.json</code>{' '}
          ...
          <div key={c.slug} className="card p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <code className="mt-2 inline-block rounded-sm bg-surface-2 px-1.5 py-0.5 text-xs text-muted">
      ...
      <div className="card border-dashed border-line-strong p-5 text-center text-sm text-muted">
        ...
        <code className="mx-1 rounded-sm bg-surface-2 px-1.5 py-0.5 text-brand-dark">/api/admin/categories</code>
