      ...
      <section className="card p-5">
        ...
        <dl className="mt-3 space-y-3 text-sm">
          <div>
            ...
            <dd className="mt-0.5"><code className="rounded-sm bg-surface-2 px-2 py-1 text-xs text-brand-dark">npm run etsy:sync</code></dd>
          </div>
          <div>
            <dt className="text-muted">Check and mark sold stock</dt>
            <dd className="mt-0.5"><code className="rounded-sm bg-surface-2 px-2 py-1 text-xs text-brand-dark">npm run etsy:sync -- --apply</code></dd>
          </div>
          <div>
            ...
            <dd className="mt-0.5 leading-relaxed text-muted">
              ...
              <code className="rounded-sm bg-surface-2 px-1.5 py-0.5 text-xs text-brand-dark">
