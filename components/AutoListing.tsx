    ...
    <div className="grid gap-8 lg:grid-cols-[400px_1fr]">
      ...
      <div className="card h-fit p-6">
        ...
        <textarea
          ...
          rows={7}
          placeholder={EXAMPLE}
          className="mt-2 w-full rounded-lg border border-line bg-canvas p-3 text-sm leading-relaxed outline-hidden placeholder:text-muted/40 focus:border-brand/60"
        />
        <button
        ...
        <input
          ...
          placeholder="https://…"
          className="mt-2 w-full rounded-lg border border-line bg-canvas p-2.5 text-sm outline-hidden placeholder:text-muted/40 focus:border-brand/60"
        />
